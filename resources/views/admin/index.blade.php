                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="dropdown default">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a href="javascript:void(0);">Diese Woche</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">Letzte Woche</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div>
                        <div class="mb-2">
                            <div class="block-legend">
                                ...
                                <div class="text-tiny">Umsatz</div>
                            </div>
                        </div>
                ...
                <div class="wg-table table-all-user">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th style="width: 80px">Bestellnr.</th>
                                    <th>Name</th>
                                    ...
                                    <th class="text-center">Geliefert am</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">Bestellt</td>
